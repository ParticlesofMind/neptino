...
const listings = [
  {
    title: "STEM Lab Pack",
    summary: "Hands-on labs and project templates.",
  },
  {
    title: "Historical Debates",
    summary: "Ready-to-run primary source discussions.",
  },
  {
    title: "Creative Writing",
    summary: "Prompts, rubrics, and peer review flows.",
  },
];

export default function TeacherMarketplacePage() {
  return (
    <TeacherShell activePath="/teacher/marketplace">
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
        <header>
          <h1 className="text-3xl font-bold text-foreground">Marketplace</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Discover curated course packs and reusable activities.
          </p>
        </header>

...
interface PromptLessonConstraint {
  lessonNumber: number
...
interface PromptGlobalConstraint {
  topics?: number
  objectives?: number
  tasks?: number
}
...
function parsePromptGlobalConstraint(prompt: string): PromptGlobalConstraint {
...
function parsePromptLessonConstraints(prompt: string): Map<number, PromptLessonConstraint> {
...
function fitToCount(items: string[], targetCount: number, fallbackPrefix: string): string[] {
...
function normalizeGeneratedLessons(

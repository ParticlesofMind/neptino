...
class CurriculumManager {
  ...
  private readonly defaultCanvasDimensions = {
    width: 1122,
    height: 793,
  };

  // Default canvas margins
  ...
  private readonly templateAccentPalette = [
    "template-accent--sky",
    "template-accent--mint",
    "template-accent--lavender",
    "template-accent--peach",
    "template-accent--sand",

// ==========================================================================
// SIMPLE CLASSIFICATION FORM HANDLER
// ==========================================================================
// Uses standard <select> elements with programmatic population
// Keeps all original data sources and cascading logic
...
export class SimpleClassificationFormHandler {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.error("Error initializing Simple Classification Form Handler:", error);
...
document.addEventListener("DOMContentLoaded", () => {
  if (document.getElementById("course-classification-form")) {
    new SimpleClassificationFormHandler();
  }
});

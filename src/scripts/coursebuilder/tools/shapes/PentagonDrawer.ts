/**
 * Pentagon Shape Drawer
 * Handles drawing of regular pentagons (5-sided polygons)
 */

import { BaseShapeDrawer } from "./BaseShapeDrawer";
import { ShapeDrawingContext, StrokeStyle, FillStyle } from "./types";

export class PentagonDrawer extends BaseShapeDrawer {
    draw(context: ShapeDrawingContext, strokeStyle: StrokeStyle, fillStyle?: FillStyle): void {
        ...
        // Generate pentagon points (5 sides)
        const points: number[] = [];
        for (let i = 0; i < 5; i++) {
    ...
    applyProportionalConstraints(context: ShapeDrawingContext): ShapeDrawingContext {
        ...
        // Make it a regular pentagon by using the larger dimension

...
export const BLOCK_FIELDS: Record<BlockId, TemplateFieldConfig[]> = {
  ...
  content: [
    ...
    { key: "instruction", label: "Instruction", required: true, forTypes: ["lesson", "lab", "workshop", "discussion", "reflection", "survey"] },
    { key: "practice",    label: "Practice",    required: true, forTypes: ["lesson", "lab", "workshop", "discussion", "reflection", "survey"] },
    { key: "feedback",    label: "Feedback",    required: true, forTypes: ["lesson", "lab"] },
  ...
  assignment: [
    ...
    { key: "instruction", label: "Instruction", required: false, forTypes: ["lesson"] },
    { key: "practice",    label: "Practice",    required: false, forTypes: ["lesson"] },
    { key: "feedback",    label: "Feedback",    required: false, forTypes: ["lesson"] },
  ...
  scoring: [
    ...
    { key: "feedback", label: "Feedback", required: true,  forTypes: ["lesson", "quiz", "assessment", "project", "lab"] },
  ],
  footer: [

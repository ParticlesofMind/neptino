...
export const CARD_SPECS: CardSpec[] = [
  ...
  // ─── Interactive ──────────────────────────────────────────────────────────────
  {
    ...
    label: "Interactive",
    description: "Quiz, question, or graded interaction.",
  ...
  },
  {
    cardType: "rich-sim",
    label: "Simulation",
    description: "Embeddable interactive simulation.",
  ...
  },
  {
    cardType: "village-3d",
    label: "3D Scene",
    description: "Immersive 3D exploration environment.",
    detail: "Embed a 3D exploration environment. Configure the starter prompt and navigation scaffolding for learners.",
    fields: ["Scene URL", "Prompt", "Checkpoints"],
    group: "interactive",
    Icon: Box,
  },
]

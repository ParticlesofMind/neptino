...
export const CARD_SPECS: CardSpec[] = [
  ...
  // ─── Products (Layer 3 — assembled, passive) ──────────────────────────────────
  {
    ...
    detail: "Configure an AI persona, Ollama model, opening message, learning objectives, and conversation starters. Students chat with the character to explore a topic.",
    fields: ["AI persona", "Ollama model", "Topic", "Opening message", "Conversation starters", "Max turns"],
    group: "products",
    Icon: Bot,
  },
  {
    ...
    label: "Text editor",
    description: "Embedded writing surface powered by TipTap.",
    detail: "A barebones rich-text workspace for drafting, annotating, and guided writing directly inside the layout.",
    fields: ["Title", "Document body", "Placeholder", "Mode"],
    group: "products",
    Icon: FileText,
  },
  {
    cardType: "code-editor",
    label: "Code editor",
    description: "Embedded code workspace powered by CodeMirror.",
    detail: "Syntax-highlighted code editor with language selection, starter prompt, and a clean reading-focused surface for live coding examples.",
    fields: ["Title", "Language", "Starter code", "Prompt"],
    group: "products",
    Icon: Code2,
  },
  {
    cardType: "whiteboard",
    label: "Whiteboard",
    description: "Embedded whiteboard powered by tldraw.",
    detail: "A lightweight infinite canvas for sketching diagrams, concept maps, annotations, and lesson-side brainstorming.",
    fields: ["Title", "Board prompt", "Board key"],
    group: "products",
    Icon: PenTool,
  },
  {

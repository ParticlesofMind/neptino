...
export const MEDIA_SAMPLE_CONTENT: Partial<Record<CardType, Record<string, unknown>>> = {
  ...
  "source-excerpt": {
    ...
    excerpt: "Every imported passage should retain its source, locator, license, and review state before it becomes lesson evidence.",
    context: "Use this card for short primary or secondary passages that students will cite, annotate, or evaluate.",
    locator: "Archive item, page, paragraph, timestamp, or map sheet",
    citationTitle: "Source record",
    sourceUrl: "",
  ...
  bibliography: {
    ...
    style: "short",
    entries: [
      { title: "Primary source", creator: "Archive or institution", year: "2026", url: "", license: "Review required" },
      { title: "Supporting dataset", creator: "Data provider", year: "2026", url: "", license: "Review required" },
      { title: "Context source", creator: "Publisher", year: "2026", url: "", license: "Review required" },
    ],
    notes: "Rank sources by trust, classroom fit, rights clarity, and teacher review.",
  },
  "gis-layer": {
    title: "Historical boundary layer",
    layerType: "boundary",
    geometryType: "GeoJSON",
    featureCount: 1,
    dateRange: "c. 1845",
    geometryPrecision: "Source-backed polygon required",
    sourceUrl: "",
    warnings: ["Do not use schematic geometry as source truth."],
  },
  document: {

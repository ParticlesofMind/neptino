      ...
      <div className="flex-1 overflow-auto px-4 py-3 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={addEvent}
            className="inline-flex items-center gap-1 rounded-md border border-neutral-200 px-2 py-1 text-[11px] text-neutral-600 hover:bg-neutral-50"
          >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              <label className="space-y-1">
                ...
                <input
                  ...
                  className="w-full border border-neutral-200 bg-white px-2 py-1 text-[12px] font-mono text-neutral-700 outline-none focus:border-neutral-400"
                />
              </label>
              <label className="space-y-1">
                ...
                <input
                  ...
                  className="w-full border border-neutral-200 bg-white px-2 py-1 text-[12px] text-neutral-700 outline-none focus:border-neutral-400"
                />
              </label>
            </div>
            ...
            <label className="block space-y-1">
              ...
              <textarea
                ...
                className="w-full resize-none border border-neutral-200 bg-white px-2 py-1 text-[11px] text-neutral-700 outline-none focus:border-neutral-400"
              />
            </label>
          </div>
        ))}

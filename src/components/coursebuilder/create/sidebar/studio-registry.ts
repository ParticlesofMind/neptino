...
const STUDIO_PROFILES: Partial<Record<CardType, StudioProfile>> = {
  ...
  embed: DOCUMENT_PROFILE,
  flashcards: GAMES_PROFILE,
  "code-snippet": DEFAULT_PROFILE,
  ...
  form: INTERACTIVE_PROFILE,
  "voice-recorder": INTERACTIVE_PROFILE,
  sorter: GAMES_PROFILE,
